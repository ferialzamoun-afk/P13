...
> **Note de mise a jour 2026-07-18** : l'entree 14 conserve l'historique de generation des captures. La reference courante de livraison est desormais le notebook enrichi BC05 a 65 cellules, avec 13 graphiques Phase II + 12 visuels BC05. La matrice decisionnelle stricte utilise `critical_score` pour `Critique` et `surveillance_score` pour `A surveiller`.
